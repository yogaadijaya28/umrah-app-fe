        ...
        <>
            ...
            <div className="content overflow-hidden">
                ...
                <div className="lg:h-screen sm:h-full w-full lg:py-32 sm:py-20 sm:px-15">
                    <img src="/assets/icons/ic-502.svg" alt="" className="m-auto lg:w-[250px] lg:h-[250px] sm:w-[160px] sm:h-[160px] object-cover" />
                    <div className="flex flex-col justify-center items-center lg:w-[400px] sm:w-full m-auto mt-5">
                        <p className="text-primary text-xl font-epilogue font-bold text-center">Bad Gateway</p>
